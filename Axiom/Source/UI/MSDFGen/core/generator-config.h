...
namespace msdfgen {
    ...
    struct ErrorCorrectionConfig {
        ...
        /// Configuration of whether to use an algorithm that computes the exact shape distance at the positions of suspected artifacts. This algorithm can be
        /// much slower.
    ...
    struct GeneratorConfig {
        /// Specifies whether to use the version of the algorithm that supports overlapping contours with the same winding. May be set to false to improve
        /// performance when no such contours are present.
        bool overlapSupport;
