...
#define MSDFGEN_CORNER_DOT_EPSILON .000001
    ...
    class Shape {
      ...
      public:
        struct Bounds {
            // NOTE: b is actually the lower Y-coordinate and t the higher Y-coordinate. For Y_DOWNWARD orientation, b is actually the top and t the bottom. May
            // be renamed in a future version.
            double l, b, r, t;
        };
