...
namespace SPIRV_CROSS_NAMESPACE {
    ...
    class CFG {
      public:
        ...
        const SPIRFunction& get_function() const { return func; }
        ...
        bool is_reachable(uint32_t block) const { return visit_order.count(block) != 0; }
        ...
        template <typename Op> void walk_from(std::unordered_set<uint32_t>& seen_blocks, uint32_t block, const Op& op) const {
    ...
    class DominatorBuilder {
      public:
        ...
        uint32_t get_dominator() const { return dominator; }
